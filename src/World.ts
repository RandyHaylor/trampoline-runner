...
export class World {
  ...
  update(dt: number): void {
    ...
    // Get entities from worldGen if available
    if (this.worldGen) {
    ...
    // Remove entities far behind the player (only for non-worldGen mode)
    if (!this.worldGen) {
